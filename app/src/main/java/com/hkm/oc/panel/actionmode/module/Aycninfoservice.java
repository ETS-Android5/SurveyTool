...
public class Aycninfoservice extends Service {
    ...
    private basebottom intent_class;
    private boolean bound = false;

    public class HandleBinder extends Binder {
        public Aycninfoservice getService() {
            return Aycninfoservice.this;
        }

        public void bindActivity(basebottom in) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case START:
                    ...
                    break;
                case TOAST:
                    Tool.trace(Aycninfoservice.this, output);
                    break;
                case TIMEOUT:
                    if (bound) {

 ...
 */
public class RetrieveViewAdapter extends ArrayAdapter<LocationMap> {
    public String TAG = "photoAA";
    private LayoutInflater mInflater;
    private Context ctx;
    private List<LocationMap> list;
    private int LayoutResId;

    //R.layout.single_photoview_layout
    public RetrieveViewAdapter(Context context, List<LocationMap> values, int LayoutResId) {
    ...
    public RetrieveViewAdapter(Context context, List<LocationMap> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            RetrieveView holder = new RetrieveView(ctx, convertView, position);
            holder.renderView();
            convertView.setTag(holder);
        } else {
            RetrieveView recall = (RetrieveView) convertView.getTag();

...
/**
 * Created by Hesk on 16/7/2014.
 */
public class StandJsonResponse {
    ...
    private final String
            ...
            MESSAGE = "message",
            TIME = "timestamp";
    private String returned_data, message;
    private long return_time_stamp;
    private boolean transaction_result;
    private single_event json_success_action;
    private double_event json_success_action_d;

    public StandJsonResponse() {
    }

    public StandJsonResponse fromString(String received_raw_string) {
        returned_data = received_raw_string;
        return this;
    }

    public StandJsonResponse setSingleSuccessAction(single_event action) {
        json_success_action = action;
        return this;
    }

    public void setDoubleEventActions(double_event action) {
        json_success_action_d = action;
    }
    ...
    public interface single_event {
        public void onsuccess(final long time_stamp);
    }

    public interface double_event {
        public void onsuccess(final long time_stamp);

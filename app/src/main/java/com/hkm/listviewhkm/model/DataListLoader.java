...
import static com.hkm.U.Content.allow_demo_list_gen;
import static com.hkm.U.Content.current_sketch_map;
import static com.hkm.listviewhkm.model.RouteNodeControl.create_sample_list_items;
...
public class DataListLoader extends AsyncTaskLoader<Cursor> {
    ...
    public Cursor loadInBackground() {
        ...
        if (current_sketch_map.get_route_size() == 0 && allow_demo_list_gen)
            create_sample_list_items(getContext());
        // Create corresponding array of entries and load with data.
        list = current_sketch_map.getRouteNodeList();

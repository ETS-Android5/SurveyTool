...
package com.hkm.uipack.ScrollView;

/**
 * Created by hesk on 1/22/2015.
 */
...
import com.hkm.uipack.ScrollView.ObservableScrollView;
...
public class QuickReturnFragment extends Fragment implements ObservableScrollView.Callbacks {
    ...
    public QuickReturnFragment(
            int layout_fragment_content,
            int scroll_view,
            int stick,
            int placeholder) {
        this.layout_fragment_content = layout_fragment_content;
        this.scroll_view_id = scroll_view;
        this.sticky_id = stick;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater
                .inflate(layout_fragment_content, container, false);

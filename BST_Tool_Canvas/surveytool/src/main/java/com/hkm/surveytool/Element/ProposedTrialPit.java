...
import com.hkm.surveytool.Element.Math.DotPair;
import com.hkm.surveytool.Element.Math.EQPool;
import com.hkm.surveytool.Element.Math.TPBox;
import com.hkm.surveytool.Element.Math.line_eq;
import com.hkm.surveytool.Element.Shapes.Element;
import com.hkm.surveytool.Listener.ActionModeMenu;
import com.hkm.surveytool.Listener.PTModeCallback;
...
*/
    ...
    private static ActionModeMenu tp_action_mode_cb_controller;

    //R.layout.actionmode_tp_dimension
    private void set_tp_control_view(@LayoutRes int layout_button_layout) {
        View layout = LayoutInflater.from(ctx).inflate(layout_button_layout, null);
        action_mode_bar_object.setCustomView(layout);
        final Button bw = (Button) layout.findViewById(R.id.tp_width_but);
        final Button bh = (Button) layout.findViewById(R.id.tp_height_but);
        TextView tw = (TextView) layout.findViewById(R.id.tp_width_view);
        TextView th = (TextView) layout.findViewById(R.id.tp_height_view);
        tp_action_mode_cb_controller.setUpActionModeMenu(mfragmentgr, th, tw);
        bw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tp_action_mode_cb_controller.onClick(bw);
            }
        });
        bh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tp_action_mode_cb_controller.onClick(bh);
            }
        });
    }

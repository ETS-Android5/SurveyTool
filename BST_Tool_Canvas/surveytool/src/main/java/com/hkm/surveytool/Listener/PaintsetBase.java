...
public class PaintsetBase {
    ...
    private int res_basic_default = R.color.basic_default_nothing;
    private int color_basic_dot = res_basic_default;
    private int color_basic_dot_ready = R.color.basic_default_nothing_3;
    private int color_basic_dot_selected = R.color.basic_default_nothing_1;
    private int color_child_dot = R.color.basic_default_nothing_2;
    private int color_child_dot_ready = R.color.basic_default_nothing_4;
    private int color_child_dot_selected = R.color.basic_default_nothing_5;

    public void setColor_BASIC_DOT(@ColorRes int colorResInt) {
        color_basic_dot = colorResInt;
    }

    public void setColor_BASIC_DOT_READY(@ColorRes int colorResInt) {
        color_basic_dot_ready = colorResInt;
    }

    public void setColor_BASIC_DOT_SELECTED(@ColorRes int colorResInt) {
        color_basic_dot_selected = colorResInt;
    }

    public void setColor_CHILD_DOT(@ColorRes int colorResInt) {
        color_child_dot = colorResInt;
    }

    public void setColor_CHILD_DOT_READY(@ColorRes int colorResInt) {
        color_child_dot_ready = colorResInt;
    }

    public void setColor_CHILD_DOT_SELECTED(@ColorRes int colorResInt) {
        color_child_dot_selected = colorResInt;
    }
    ...
    public Paint g(int n) {
        ...
        switch (n) {
            ...
            case PaintsetBase.BASIC_DOT:
                p.set(p_indication);
                p.setColor(ctx.getResources().getColor(color_basic_dot));
                break;
            case PaintsetBase.BASIC_DOT_READY:
                p.set(p_indication);
                p.setColor(ctx.getResources().getColor(color_basic_dot_ready));
                p.setAlpha(70);
                break;
            case PaintsetBase.BASIC_DOT_SELECTED:
                p.set(p_indication);
                p.setColor(ctx.getResources().getColor(color_basic_dot_selected));
                p.setAlpha(80);
                break;
            case PaintsetBase.CHILD_DOT:
                p.set(p_indication);
                p.setColor(ctx.getResources().getColor(color_child_dot));
                p.setAlpha(80);
                break;
            case PaintsetBase.CHILD_DOT_READY:
                p.set(p_indication);
                p.setColor(ctx.getResources().getColor(color_child_dot_ready));
                p.setAlpha(80);
                break;
            case PaintsetBase.CHILD_DOT_SELECTED:
                p.set(p_indication);
                p.setColor(ctx.getResources().getColor(color_child_dot_selected));
                p.setAlpha(80);
                break;

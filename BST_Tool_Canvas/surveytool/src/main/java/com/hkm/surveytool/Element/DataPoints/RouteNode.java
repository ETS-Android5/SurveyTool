...
public class RouteNode implements Serializable{
    ...
    transient protected SymbolC.indicator mindicator = SymbolC.indicator.FINAL;
    transient protected SymbolC.status pattern_status = SymbolC.status.INITIAL;
    ...
    public SymbolC.indicator getIndicate() {
        return mindicator;
    }

    public RouteNode setIntdicate(SymbolC.indicator i) {
        mindicator = i;
        return this;
    }

...
//http://tech.chitgoks.com/2012/07/08/android-draw-equilateral-triangle-shapes-in-canvas/
    ...
    public static int m2p(float meter) {
        double px = meter * Content.dpi / inch_meter_ratio * 1 / Content.current_sketch_map.getratio();
    ...
    public static float p2m(float pixel) {
        ...
        double meter = pixel * Content.current_sketch_map.getratio() * inch_meter_ratio / Content.dpi;
        return (float) meter;
    }

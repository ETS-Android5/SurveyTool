...
import com.hkm.oc.panel.corepanel.elements.mathmodels.Geometry;
import com.hkm.oc.panel.corepanel.elements.shapes.Element;

import java.util.ArrayList;

/**
 * this is the ruler created by hesk 2014
 */
public class AbPointRuler extends Element implements View.OnClickListener {
    ...
    public AbPointRuler(Canvas mainCanvas, BigObserveDot RefPointA, BigObserveDot RefPointB, MapPanel panel, Pen pen) {
        ...
        realA = RefPointA;
        realB = RefPointB;
        actual_distance = Content.current_sketch_map.getRealDistanceAB();
        enableRuler = true;
    }
   ...
   */
    ...
    public String showBarInfo() {
        ratio_m = (float) Content.current_sketch_map.getratio();
    ...
    public static String ratio_calculate(final float meter, final PointF A, final PointF B) {
        ...
        final double screen2inches = screen_distance_dp / Content.dpi;
        ...
        Log.d(TAG, e);
        Content.current_sketch_map.setRatio(compare);
        Content.current_sketch_map.setRealDistanceAB(meter);
        return e;
    }
}
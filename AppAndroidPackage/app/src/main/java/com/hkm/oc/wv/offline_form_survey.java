 ...
 */
public class offline_form_survey extends webviewSupports {
    private static String file_local = "file:///android_asset/html_app/formcustomersurveyeval.html";
    private String TAG = "onecall offline_form_survey";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.form_wcs, menu);

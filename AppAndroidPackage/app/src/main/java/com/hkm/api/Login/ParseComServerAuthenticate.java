...
public class ParseComServerAuthenticate implements ServerAuthenticate {
    public static String TAG = "parseComServerAuth";
    ...
    public String userSignUp(String name, String email, String pass, String authType) throws Exception {
        ...
        httpPost.addHeader("X-Parse-Application-Id", X_APPLICATION_ID);
        httpPost.addHeader("X-Parse-REST-API-Key", X_REST_API_KEY);
    ...
    public String userSignIn(String user, String pass, String authType) throws Exception {
        ...
        httpGet.addHeader("X-Parse-Application-Id", X_APPLICATION_ID);
        httpGet.addHeader("X-Parse-REST-API-Key", X_REST_API_KEY);

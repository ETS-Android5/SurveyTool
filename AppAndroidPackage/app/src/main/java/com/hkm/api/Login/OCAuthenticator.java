...
import static com.hkm.api.Login.AccountGeneral.*;
import static android.accounts.AccountManager.KEY_BOOLEAN_RESULT;
/**
 * Created by hesk on 5/27/2014.
 */
public class OCAuthenticator extends AbstractAccountAuthenticator {

        private String TAG = "OCAuthenticator";
        private final Context mContext;

        public OCAuthenticator(Context context) {
            super(context);
